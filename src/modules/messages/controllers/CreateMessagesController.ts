...
import { VerifyIfExistsChannelConnectToUserMessageService } from '@modules/channelConnected/services/VerifyIfExistsChannelConnectToUserMessageService'
...
export class CreateMessagesController {
  async handle(request: Request, response: Response) {
    ...
    const verifyIfExistsChannelConnectToUserService = new VerifyIfExistsChannelConnectToUserMessageService()
